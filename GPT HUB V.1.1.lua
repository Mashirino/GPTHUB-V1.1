...
ServerTimeLabel.Position = UDim2.new(0.5, 50, 0.5, 0) -- ชิดกลางแน่นอน
...
ServerTimeLabel.TextColor3 = Color3.fromRGB(255,255,255) -- เปลี่ยนเป็นขาว
ServerTimeLabel.TextXAlignment = Enum.TextXAlignment.Center
ServerTimeLabel.TextYAlignment = Enum.TextYAlignment.Center -- ให้อยู่ตรงกลางแนวตั้งด้วย
...
local function LoadFruitTab()
    ...
    warn.Text = "⚠ WARNING: Using Auto Barrel may result in a ban.\nUse Auto Drink & Mix only."
    ...
    warnTH.Text = "⚠ คำเตือน: การใช้ Auto Barrel อาจทำให้ถูกแบน\nแนะนำให้ใช้เฉพาะ Auto Drink และ Mix เท่านั้น"
...
local function SetActiveTab(tabName)
    for name, btn in pairs(TabButtons) do
        if name == tabName then
            btn.BackgroundColor3 = Color3.fromRGB(0,170,255) -- ✅ สีของแท็บที่เลือก
        else
            btn.BackgroundColor3 = Color3.fromRGB(40,40,40) -- ปุ่มที่ไม่ถูกเลือก
        end
    end
end
...
-- Load default
LoadMainTab()
AddLog("GPT HUB V4.3 FINAL loaded (merged features + Fruit)")
